(function(root,factory){
  ...
  function wrapRenderMap(runtimeRoot=root){const original=runtimeRoot?.renderMap;if(typeof original!=='function')return false;if(original.__runFlowV3)return true;function wrapped(){const result=original.apply(this,arguments);decorateMap(runtimeRoot);return result}wrapped.__runFlowV3=true;wrapped.__runFlowV2=true;wrapped.__original=original;runtimeRoot.renderMap=wrapped;return true}
