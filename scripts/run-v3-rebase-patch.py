...
# The smoke test wants the first actionable node. V3 can leave decorative/non-actionable
# buttons outside the legacy lock/done heuristic, so target the runtime's canonical current state.
...
path.write_text(text.replace(old_selector,new_selector,1),encoding='utf-8')
