...
function browserFallbackMigratedDefinitions(){
  const rows=[
    ...
    {id:'core.pureboost',legacyTacticId:'pureboost',name:'기본에 충실',suit:'D',rank:5,text:'이 카드를 낼 때 손패에 순수 카드가 1장 이상 있으면 트릭 숫자 +2.',terms:['순수 카드','손패','트릭값'],activation:'이 카드를 낼 때',migrationStage:'7.5-P',effects:[{trigger:'on_play',action:'increase_next_trick_rank',value:2,condition:'pure_card_in_hand',duration:'trick'}]},
