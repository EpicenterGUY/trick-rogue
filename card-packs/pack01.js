(function(root,factory){const value=factory();if(typeof module!=='undefined')module.exports=value;root.PACK01_CARDS=value})(typeof globalThis!=='undefined'?globalThis:this,function(){
  return [
  {
    ...
    "suit": "S",
    "rank": 7,
    "description": "발동: 이 카드로 트릭 승리 시 즉시 적에게 피해 3. 추가: 이 카드가 쇼다운 5장 중 하나면 최종 쇼다운 위력 +3.",
  ...
  },
  {
    ...
    "suit": "S",
    "rank": 5,
    "description": "발동: 이 카드로 트릭 승리 시 적에게 출혈 3 부여. 출혈은 트릭 종료 시 피해를 주고 1 감소한다.",
    "terms": ["출혈","트릭","피해"],
  ...
  },
  {
    ...
    "suit": "S",
    "rank": 14,
    "description": "손에 들고 있는 동안 각 트릭 종료 시 20% 확률로 소진되어 이번 전투 동안 사용할 수 없다. 소진되지 않고 정확히 5번 쇼다운 슬롯에 제출하면 최종 쇼다운 위력 +12. 손에 없으면 소진 판정하지 않는다.",
    "terms": ["트릭","소진","전투","쇼다운 슬롯","최종 위력"],
