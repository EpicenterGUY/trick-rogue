(function(root,factory){const value=factory();if(typeof module!=='undefined')module.exports=value;root.PACK01_CARDS=value})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  },
  {
    ...
    "suit": "D",
    "rank": 7,
    "description": "조건: 이번 트릭에서 칩을 1 이상 실제로 소비한 상태로 이 카드로 트릭 승리. 효과: 칩 +1, 전술 카드 1장 드로우.",
    "terms": [
      "트릭"
    ],
  ...
  },
  {
    ...
    "suit": "C",
    "rank": 8,
    "description": "발동: 이 카드로 트릭 승리 시 직전에 발동한 다른 네임드 카드의 수치 효과 하나를 1회 복사. 복사 범위는 피해, 회복, 칩, 보호막, 출혈, 예측, 전술 카드 드로우이며 자기 자신은 복사하지 않는다.",
    "terms": [
      "트릭"
    ],
