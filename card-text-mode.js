...
increase_effective_rank:'트릭 숫자',showdown_power:'쇼다운 위력',reserve_next_win_damage:'예약 피해',
  ...
  return{SUIT_SYMBOL,RED_SUITS,ACTION_LABELS,escapeHtml,rankLabel,cardName,effectList,shouldUseTextFace,summarizeEffects,textCardFace,renderCardFace,install,installWhenReady,setEnabled,isEnabled};
});
