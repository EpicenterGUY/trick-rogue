(function(root,factory){
  ...
  function frozenNode(id,type,lane,row,next=[]){return Object.freeze({id,type,lane,row,next:Object.freeze([...next])})}
  ...
  function regionAct(id,name,prefix){return frozenAct({id,index:1,name,entryNodeIds:[`${prefix}0`],nodes:[
    frozenNode(`${prefix}0`,'battle',1,0,[`${prefix}1`,`${prefix}2`]),
    frozenNode(`${prefix}1`,'event',0,1,[`${prefix}3`]),
    frozenNode(`${prefix}2`,'battle',2,1,[`${prefix}4`]),
    frozenNode(`${prefix}3`,'camp',0,2,[`${prefix}5`]),
    frozenNode(`${prefix}4`,'shop',2,2,[`${prefix}5`]),
  ...
  const ACT_DEFINITIONS=Object.freeze({
    ...
    region_theater:regionAct('region_theater','유랑극장','t'),
    region_observatory:regionAct('region_observatory','안개 관측소','o'),
    region_frontier:regionAct('region_frontier','황야 전선','w'),
    final:frozenAct({id:'final',index:3,name:'최종지역',entryNodeIds:['f0'],nodes:[
