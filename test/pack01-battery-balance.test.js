...
test('배터리 1%는 소진 위험 20%와 5번 슬롯 보너스 +12를 사용한다',()=>{
  ...
  assert.equal(battery.name,'배터리 1%');
...
test('pack01 개성화 재설계 수치와 표시명을 유지한다',()=>{
  const expected={
    'pack01.black_bullet':{name:'검은 탄환',flat:['damage_enemy',4,'damage_enemy',4]},
    'pack01.phoenix':{name:'불사조',flat:['heal_player',3,'heal_player',4]},
    ...
    'pack01.scheduled_delivery':{name:'예약 사격',flat:['reserve_next_win_damage',8]},
    'pack01.emergency_guard':{name:'비상 방패',flat:['gain_shield',6,'showdown_power',6]},
    'pack01.sharp_glass':{name:'유리 칼날',flat:['damage_enemy',3,'apply_enemy_bleed',3]},
