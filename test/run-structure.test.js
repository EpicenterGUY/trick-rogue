...
test('등록된 다섯 지역은 각각 두 내부 분기 메타데이터를 가진다',()=>{
  assert.deepEqual(Object.keys(RunStructure.REGION_BRANCHES),['region_theater','region_observatory','region_frontier','region_casino','region_red_ward']);
