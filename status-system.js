(function(root,factory){
  ...
  const STATUS_PRESENTATION=Object.freeze({
    ...
    scar:Object.freeze({id:'scar',label:'흉터',kind:'debuff',chipClass:'red',description:'트릭 종료 시 현재 수치만큼 피해를 받는다. 전투 동안 자연 감소하지 않으며 최대 2까지 쌓인다.',timing:'트릭 종료'}),
    mark:Object.freeze({id:'mark',label:'표식',kind:'debuff',chipClass:'gold',description:'다음 양수 피해를 받을 때 보호막 계산 전에 피해량이 현재 수치만큼 증가하고, 발동 후 모두 사라진다. 최대 5까지 쌓인다.',timing:'다음 피해를 받을 때'}),
